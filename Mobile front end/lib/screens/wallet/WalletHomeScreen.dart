...
class WalletHomeScreen extends StatefulWidget {
  ...
  WalletHomeScreen(Student? stu)
  {
    this._selectedstu = stu;
  }
  @override
  _WalletHomeScreenState createState() => _WalletHomeScreenState(this._selectedstu);
}
...
class _WalletHomeScreenState extends State<WalletHomeScreen> {
  ...
  _WalletHomeScreenState(Student? stu)
  {
    this._selectedstu = stu;
  }
  ...
  initdata()async {
    ...
    _payment = await db.getPaymentByStudent(this._selectedstu!.StudentID);
    print(_payment.toString());
    setState(() {
                ...
                body: _isLoading
                  ...
                  children: <Widget>[
                    ...
                    Container(
                        ...
                        child: Column(
                          children: this._payment.map((e) {
                                   return Column(
                                       children: <Widget> [_TransactionWidget(
                                    name: e.Payment +"-"+e.Month,
                                    date: e.Stamp,
