...
@Component({
  ...
  templateUrl: './all-finance.component.html',
  styleUrls: ['./all-finance.component.sass'],
})
export class AllFinanceComponent
  ...
  implements OnInit
{
  ...
  exampleDatabase: FinanceService| null;
  ...
  async loadData() {
    this.exampleDatabase = new FinanceService(this.httpClient);
...
export class ExampleDataSource extends DataSource<Students> {
  ...
  constructor(
    public exampleDatabase: FinanceService,
