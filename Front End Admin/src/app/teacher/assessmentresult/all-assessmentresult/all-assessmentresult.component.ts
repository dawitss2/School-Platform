...
@Component({
  selector: 'app-all-assessmentresult',
  templateUrl: './all-assessmentresult.component.html',
  styleUrls: ['./all-assessmentresult.component.sass'],
})
export class AllAssessmentresultComponent
  ...
  implements OnInit
{
  ...
  exampleDatabase: AssessmentresultService | null;
  ...
  public loadData() {
    this.exampleDatabase = new AssessmentresultService (this.httpClient);
...
export class ExampleDataSource extends DataSource<Students> {
  ...
  constructor(
    public exampleDatabase: AssessmentresultService ,
